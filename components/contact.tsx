...
export default function Contact() {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/ismailox-01",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/ismail-bouhaba/",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Email",
      url: "https://mail.google.com/mail/?view=cm&to=bouhaba.ismail.02@gmail.com",
      icon: (
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                  href="https://mail.google.com/mail/?view=cm&to=bouhaba.ismail.02@gmail.com"
                        className="text-muted-foreground hover:text-primary transition-colors"
                        target="_blank"
                      >
                        bouhaba.ismail.02@gmail.com
                      </a>
                    </div>
                  </div>
